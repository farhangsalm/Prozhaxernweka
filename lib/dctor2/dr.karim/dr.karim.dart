...
import 'package:flutter_application_1/dctor2/dr.karim/tab.dart';
...
class dctorkarim extends StatelessWidget {
  const dctorkarim({
    Key? key,
    required this.karim,
    required this.size,
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => karimColorKan(
                karim: karim), // Replace ColorKan with your desired page
          ),
        );
      },
      child: Container(
...
class karimColorKan extends StatefulWidget {
  const karimColorKan({Key? key, required this.karim}) : super(key: key);
  final Karim karim;

  @override
  State<karimColorKan> createState() => _karimColorKanState();
}

class _karimColorKanState extends State<karimColorKan> {
...
class karim2DetailsPage extends StatefulWidget {
  karim2DetailsPage({
    Key? key,
  }) : super(key: key);

  @override
  _karim2DetailsPageState createState() => _karim2DetailsPageState();
}

class _karim2DetailsPageState extends State<karim2DetailsPage>
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                    ListView.builder(
                      itemCount: karim.length,
                      itemBuilder: (context, index) => dctorkarim(
                        itemIndex: index,
                        karim: karim[index],
                        size: size,
                      ),
