...
import 'package:flutter_application_1/desing2/tab.dart';
...
class indesing extends StatelessWidget {
  const indesing({
    Key? key,
    required this.inde,
    required this.size,
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                indeColorKan(inde: inde), // Replace ColorKan with your desired page
          ),
        );
      },
      child: Container(
...
class indeColorKan extends StatefulWidget {
  const indeColorKan({Key? key, required this.inde}) : super(key: key);
  final Inde inde;

  @override
  State<indeColorKan> createState() => _indeColorKanState();
}

class _indeColorKanState extends State<indeColorKan> {
...
class indesingDetailsPage extends StatefulWidget {
  ...
  @override
  _indesingDetailsPageState createState() => _indesingDetailsPageState();
}

class _indesingDetailsPageState extends State<indesingDetailsPage>
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                    ListView.builder(
                      itemCount: inde.length,
                      itemBuilder: (context, index) => indesing(
                        itemIndex: index,
                        inde: inde[index],
                        size: size,
                      ),
