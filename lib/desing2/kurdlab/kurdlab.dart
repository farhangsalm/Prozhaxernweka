...
import 'package:flutter_application_1/desing2/kurdlab/tab.dart';
...
class kurdlab extends StatelessWidget {
  const kurdlab({
    Key? key,
    required this.lab,
    required this.size,
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                labColorKan(lab: lab), // Replace ColorKan with your desired page
          ),
        );
      },
      child: Container(
...
class labColorKan extends StatefulWidget {
  const labColorKan({Key? key, required this.lab}) : super(key: key);
  final Lab lab;

  @override
  State<labColorKan> createState() => _labColorKanState();
}

class _labColorKanState extends State<labColorKan> {
                ...
                child: TabBarView(
                  ...
                  children: [
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) => kurdlab(
                        itemIndex: index,
                        lab: lab[index],
                        size: size,
                      ),
