...
import 'package:flutter_application_1/program/bashflutter/flatr.dart';
import 'package:flutter_application_1/program/bashflutter/tabfltr.dart';
import 'package:flutter_application_1/program/bashflutter/tabpro.dart';
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ColorKan2(
                pro: widget.pro), // Replace YOUTBE with your desired page
          ),
        );
      },
      child: Container(
...
class ColorKan2 extends StatefulWidget {
  const ColorKan2({Key? key, required this.pro}) : super(key: key);
  final Pro pro;

  @override
  State<ColorKan2> createState() => _ColorKan2State();
}

class _ColorKan2State extends State<ColorKan2> {
  ...
  void initState() {
    ...
    _controller = YoutubePlayerController(
      initialVideoId: widget.pro.video, // Replace with your video ID
  ...
  void copyText() {
    Clipboard.setData(ClipboardData(text: widget.pro.content));
  ...
  Future<void> _saveLikeState() async {
    ...
    await prefs.setBool('isLiked_${widget.pro.video}', isLiked);
  }
  ...
  Future<void> _loadLikeState() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      isLiked = prefs.getBool('isLiked_${widget.pro.video}') ?? false;
    });
  }
                            ...
                            RichText(
                              text: TextSpan(
                                text: isContentExpanded
                                    ? widget.pro.content
                                    : widget.pro.content.substring(0, 169) +
                                        '... ',
                                style: const TextStyle(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        IconButton(
                                          onPressed: () {
                                            Share.share(widget.pro.content);
                                          },
                                          icon: const Icon(
                                            Icons.share,
                                            color: Colors.blue,
                                    ...
                                    StreamBuilder(
                                      stream:
                                          ref.child(widget.pro.video).onValue,
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                    ListView.builder(
                      itemCount: flatr.length,
                      itemBuilder: (context, index) => flatr1(
                        itemIndex: index,
                        flatr: flatr[index],
                        size: size,
                      ),
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) => pro1(
                        itemIndex: index,
                        pro: pro[index],
                        size: size,
                      ),
