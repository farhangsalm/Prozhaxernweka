    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                photoColorKan(photo: photo), // Replace ColorKan with your desired page
          ),
        );
      },
      child: Container(
...
class photoColorKan extends StatefulWidget {
  const photoColorKan({Key? key, required this.photo}) : super(key: key);
  final Photo photo;

  @override
  State<photoColorKan> createState() => _photoColorKanState();
}

class _photoColorKanState extends State<photoColorKan> {
                ...
                child: TabBarView(
                  ...
                  children: [
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) => photoshop(
                        itemIndex: index,
                        photo: photo[index],
                        size: size,
                      ),
