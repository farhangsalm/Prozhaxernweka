...
import 'package:flutter_application_1/desing/pexart/pextab.dart';
import 'package:flutter_application_1/desing/photoshop/taboic.dart';
...
class pexart extends StatelessWidget {
  const pexart({
    Key? key,
    required this.pex,
    required this.size,
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                pexColorKan(pex: pex), // Replace ColorKan with your desired page
          ),
        );
      },
      child: Container(
...
class pexColorKan extends StatefulWidget {
  const pexColorKan({Key? key, required this.pex}) : super(key: key);
  final Pex pex;

  @override
  State<pexColorKan> createState() => _pexColorKanState();
}

class _pexColorKanState extends State<pexColorKan> {
...
class pexDetailsPage extends StatefulWidget {
  ...
  @override
  _pexDetailsPageState createState() => _pexDetailsPageState();
}

class _pexDetailsPageState extends State<pexDetailsPage>
                ...
                child: TabBarView(
                  ...
                  children: [
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) => pexart(
                        itemIndex: index,
                        pex: pex[index],
                        size: size,
                      ),
