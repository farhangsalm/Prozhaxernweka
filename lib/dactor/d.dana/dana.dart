...
import 'package:flutter_application_1/dactor/d.dana/tabdana.dart';
...
class dctotrdana extends StatelessWidget {
  const dctotrdana({
    Key? key,
    required this.dana,
    required this.size,
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => danaColorKan(
                dana: dana), // Replace ColorKan with your desired page
          ),
        );
      },
      child: Container(
...
class danaColorKan extends StatefulWidget {
  const danaColorKan({Key? key, required this.dana}) : super(key: key);
  final Dana dana;

  @override
  State<danaColorKan> createState() => _danaColorKanState();
}

class _danaColorKanState extends State<danaColorKan> {
...
class danalDetailsPage extends StatefulWidget {
  danalDetailsPage({
    Key? key,
  }) : super(key: key);

  @override
  _danalDetailsPageState createState() => _danalDetailsPageState();
}

class _danalDetailsPageState extends State<danalDetailsPage>
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                    ListView.builder(
                      itemCount: dana.length,
                      itemBuilder: (context, index) => dctotrdana(
                        itemIndex: index,
                        dana: dana[index],
                        size: size,
                      ),
